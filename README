...
insert into ramen values('R23','CheeseBlackRamen',4000,'자장 라면','물이 만 면과 건더기스프를 넣습니다. 면을 푹 익히지 말고 꼬들하니 덜 삶겨졌을 때 물을 따라 버립니다. 그리고 대파를 썰어 넣어 마저 끓입니다. 그 다음 분말 스프를 넣고 섞을 때에도 열기 그대로 유지되도록 가스불은 끄지 않습니다. 그리고 치즈를 올립니다.','짜파게티','대파 1/2대, 슬라이스 체다치즈 1장',1,'R23.jpg');
