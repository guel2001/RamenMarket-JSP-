...
insert into ramen values('R21','ZZangRamen',2600,'자장 라면','물을 5분간 끓입니다.  그리고 면을 넣어 익힌다음 면이 촉촉해질 정도로만 물을 뺴줍니다. 그리고 짜장 스프와 고춧가루를 넣고 비벼줍니다. 그리고 후라이팬에 계란을 따로 부쳐서 라면과 같이 먹습니다.','진짜장','계란 1개, 고춧가루, 물 500ml',2,'R21.jpeg');
